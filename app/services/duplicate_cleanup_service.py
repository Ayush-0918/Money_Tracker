...
from app.schemas.admin import DuplicateGroup, DuplicateTransactionSummary, DuplicateReportResponse, DuplicateDeleteResponse
...
async def delete_duplicates(
    ...
    confirm: bool, 
    specific_ids: Optional[List[uuid.UUID]] = None
